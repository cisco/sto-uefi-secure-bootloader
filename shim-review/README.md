...
*******************************************************************************
Yes, we created the shim binaries from the 16.1 shim release at https://github.com/rhboot/shim/releases/tag/16.1
...
*******************************************************************************
No change to default NX bit setting. We tested it on our target ARM architecture with entire shim/grub bootchain.
...
*******************************************************************************
This is first application for having ARM based shim signed.
...
shim,4,UEFI shim,shim,16.1,https://github.com/rhboot/shim
...
*******************************************************************************
Have not contributed to this project, but we plan to do so.
